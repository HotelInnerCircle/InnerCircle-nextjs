...
export default function Menu() {
  ...
  const menuItems = [
    //MOCTAILS
    { name: "Mint Mocktail", category: "Mocktails", price: 179, img: "https://mindfulmocktail.com/wp-content/uploads/2022/04/ginger-mocktail-recipe.jpg" },
    { name: "Pina Colada", category: "Mocktails", price: 179, img: "https://i.pinimg.com/736x/98/52/1b/98521b4960b5c1ee4ec9b3989e568fdc.jpg" },
    { name: "Virgin Mojito", category: "Mocktails", price: 179, img: "https://i.pinimg.com/1200x/57/cd/dd/57cddd925ee9c23164c2cfb69faf0e92.jpg" },
    { name: "Fruit Punch", category: "Mocktails", price: 179, img: "https://i.pinimg.com/1200x/f3/a3/23/f3a323bcd673cb6ea2bd4bd03f1cd950.jpg" },
    { name: "Shirley Temple", category: "Soups", price: 120, img: "https://i.pinimg.com/736x/e0/5a/7a/e05a7a5b590221dcd12d5098d70c413e.jpg" },
    { name: "Watermelon Mojito", category: "Mocktails", price: 179, img: "https://i.pinimg.com/736x/b6/d4/da/b6d4dade9938d0cb8aa0d1ac908021a0.jpg" },
    { name: "Blue Lagoon", category: "Mocktails", price: 179, img: "https://i.pinimg.com/1200x/b6/ac/3f/b6ac3f8d4ff545c13e1c45edb9d43b45.jpg" },
    { name: "Milkshake", category: "Mocktails", price: 179, img: "https://i.pinimg.com/1200x/a1/09/49/a1094953d2990a7127a8e4d1e7b02715.jpg" },
    { name: "Fresh Lime Soda", category: "Mocktails", price: 119, img: "https://i.pinimg.com/736x/f8/98/74/f8987473c38e50ef49ac0ac0388ee123.jpg" },
    { name: "Fresh Lime Water", category: "Mocktails", price: 99, img: "https://i.pinimg.com/736x/44/aa/53/44aa538918577de68c478e98e029e983.jpg" },

    //SOUP — LIQUID APPETIZER
    { name: "Palak Shorba", category: "Soups", price: 195, img: "https://i.pinimg.com/736x/fa/13/52/fa1352e0f69e8a955506a2c04dcf49a6.jpg" },
    { name: "Tomato Ka Shorba", category: "Soups", price: 195, img: "https://i.pinimg.com/736x/fa/48/34/fa4834158a907a5fe92697ba440c9a85.jpg" },
  ...
  return (
    <div className="w-full min-h-screen bg-white text-black pb-24 px-6">
      ...
      <div className="max-w-xl mx-auto mb-8">
        {loading ? (
          ...
          <div className="bg-[#222] rounded-full px-6 py-3 flex items-center gap-3 shadow-lg">
            ...
            />
            <button className="text-white text-2xl"><FaSearch /></button>
          </div>
        )}
      </div>
      ...
      {/* 🍲 FOOD CARDS */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-5xl mx-auto  max-h-300 overflow-scroll">
